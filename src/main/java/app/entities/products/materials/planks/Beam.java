...
public class Beam extends Plank {
    ...
    public Beam(String name, String description, float costPrice, float salesPrice, float width, String unit, List<Integer> preCutsLengths, float height, int postGap) {
        super(name, description, costPrice, salesPrice, width, unit, preCutsLengths, height);
        this.postGap = postGap;
    }

    public Beam(int itemId, String name, String description, float costPrice, float salesPrice, String unit, float width, float height, int postGap) {
