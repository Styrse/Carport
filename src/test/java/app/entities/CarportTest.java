...
class CarportTest {
    ...
    class Structure {
        ...
        class Posts {
            ...
            class WidthTests {
                ...
                void calcPostAmountWidth_test1() {
                    ...
                    int expected = 2;
                    // Act
                    int actual = carport.calcPostCountWidth();
                    // Assert
            ...
            class PostAmountLengthTests {
                ...
                void calcPostAmountLength_test1() {
                    ...
                    int expected = 2;
                    // Act
                    int actual = carport.calcPostCountLength();
                    // Assert
                    assertEquals(expected, actual);
                }
        ...
        class Beams {
            ...
            class BeamAmountLengthTests {
                ...
                void calcBeamAmountLength_test1() {
                    ...
                    int expected = 1;
                    // Act
                    int actual = carport.calcBeamAndFasciaCountLength();
                    // Assert
                    assertEquals(expected, actual);
                }
        ...
        class Rafters {
            ...
            class RaftersLengthTests {
                ...
                void calcRaftersLength_smallCarport() {
                    ...
                    int expected = 2;
                    // Act
                    int actual = carport.calcRafterCountLength();
                    // Assert
                    assertEquals(expected, actual);
                }
            ...
            class RaftersWidthTests {
                ...
                void calcRaftersWidth_smallWidth() {
                    ...
                    int expected = 1;
                    // Act
                    int actual = carport.calcRafterAndFasciaCountWidth();
                    // Assert
                    assertEquals(expected, actual);
                }
            ...
            class TotalRaftersTests {
                ...
                void calcRafters_normalCarport() {
                    ...
                    int expected = 11;
                    // Act
                    int actual = carport.calcTotalRafters();
                    // Assert
                    assertEquals(expected, actual);
                }
        ...
        @Nested
        @DisplayName("Fascia Test")
        class Fascia {

            @Test
            @DisplayName("Total fascias test 1: small carport")
            void calcTotalFascias_smallCarport() {
                // Arrange
                Carport carport = new Carport(300, 500, "flat");
                // Expected
                int expected = 4;
                // Act
                int actual = carport.calcTotalFascias();
                // Assert
                assertEquals(expected, actual);
            }

            @Test
            @DisplayName("Total fascias test 2: just over plank length")
            void calcTotalFascias_justOverPlankLength() {
                // Arrange
                Carport carport = new Carport(300, 601, "flat");
                // Expected
                int expected = 6;
            ...
            @Test
            @DisplayName("Total fascias test 3: longer carport")
            void calcTotalFascias_longCarport() {
                // Arrange
                Carport carport = new Carport(300, 1300, "flat");
                // Expected
                int expected = 8;
                // Act
                int actual = carport.calcTotalFascias();
            ...
            @Test
            @DisplayName("Total fascias stress test: very long carport")
            void calcTotalFascias_stressTest() {
                // Arrange
                Carport carport = new Carport(300, 5000, "flat");
                // Expected
                int expected = 20;
    ...
    @Nested
    @DisplayName("Roof Test")
    class Roof {

        @Nested
        @DisplayName("Covers Test")
        class Covers {

            @Test
            @DisplayName("Roof covers test 1: small carport, no extra covers")
            void calcRoofCountLength_smallCarport() {
                // Arrange
                Carport carport = new Carport(300, 500, "flat");
                // Expected
                int expected = 1;
                // Act
                int actual = carport.calcRoofCountLength();
                // Assert
                assertEquals(expected, actual);
            }

            @Test
            @DisplayName("Roof covers test 2: exactly at plank length (600 cm)")
            void calcRoofCountLength_exactPlankLength() {
                // Arrange
                Carport carport = new Carport(300, 600, "flat");
                // Expected
                int expected = 1;
            ...
            @Test
            @DisplayName("Roof covers test 3: just over plank length (601 cm)")
            void calcRoofCountLength_justOverPlankLength() {
                // Arrange
                Carport carport = new Carport(300, 601, "flat");
                // Expected
                int expected = 2;
            ...
            @Test
            @DisplayName("Roof covers test 4: bigger carport")
            void calcRoofCountLength_biggerCarport() {
                // Arrange
                Carport carport = new Carport(300, 1200, "flat");
                // Expected
                int expected = 3;
            ...
            @Test
            @DisplayName("Roof covers stress test: very large carport")
            void calcRoofCountLength_stressTest() {
                // Arrange
                Carport carport = new Carport(300, 5000, "flat");
                // Expected
                int expected = 9;
